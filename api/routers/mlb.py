...
def pitcher_boxwhisker(date: str = None, db: Session = Depends(get_db)):
    ...
    rows = db.execute(text("""
        ...
        pitcher_game_stats AS (
            ...
            FROM mlb.boxscore_pitching bp
            JOIN mlb.games g ON g.game_pk = bp.game_pk
            WHERE g.game_date::date BETWEEN (:target_date)::date - INTERVAL '60 days'
        ...
        historical_starters AS (
            SELECT DISTINCT bp.game_pk, g.game_date, bp.player_id AS pitcher_id,
                ...
                CASE WHEN g.home_team_id = bp.team_id THEN g.away_team_id ELSE g.home_team_id END AS opp_team_id,
        ...
        opp_game_vs_sp_raw AS (
            ...
            GROUP BY hs.opp_team_id, hs.opp_side, hs.game_pk, hs.game_date, hs.pitcher_id, hs.pitch_hand
        ),
        opp_game_vs_sp AS (
